      ...
      >
        <div className="relative" style={{ width: `${TASK_LIST_WIDTH + totalGridWidth}px`}}>
            ...
            <div className="sticky top-0 z-30 flex bg-card border-b">
                <div className="sticky left-0 z-30 bg-card border-r flex items-center px-4 font-semibold" style={{ width: `${TASK_LIST_WIDTH}px`, height: `${HEADER_HEIGHT}px` }}>
                    Tasks
                </div>
                ...
                {sortedTasks.map((task, index) => {
                    ...
                    return (
                        <div key={task.id} className="flex border-b">
                            <div className="sticky left-0 z-30 bg-card border-r flex items-center px-2 py-2" style={{ width: `${TASK_LIST_WIDTH}px` }}>
