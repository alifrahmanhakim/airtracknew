...
export function LawEnforcementForm({ form, onSubmit }: LawEnforcementFormProps) {
  ...
  return (
    <form id="law-enforcement-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <CardContent>
