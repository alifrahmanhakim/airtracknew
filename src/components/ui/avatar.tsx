  ...
  <div className={cn("relative rounded-full", className)}>
    ...
    {online === true && (
       <span className="absolute bottom-0 right-0 flex h-2.5 w-2.5">
          ...
          <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-green-500 ring-1 ring-background"></span>
        </span>
    )}
    {online === false && (
         <span className="absolute bottom-0 right-0 flex h-2.5 w-2.5">
          <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-gray-400 ring-1 ring-background"></span>
        </span>
    )}
  </div>
))
