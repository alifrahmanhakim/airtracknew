...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  const statusStyles: { [key in Project['status']]: string } = {
    'On Track': 'border-transparent bg-blue-500 hover:bg-blue-600 text-white',
    'At Risk': 'border-transparent bg-yellow-500 hover:bg-yellow-600 text-white',
    'Off Track': 'border-transparent bg-red-500 hover:bg-red-600 text-white',
    'Completed': 'border-transparent bg-green-500 hover:bg-green-600 text-white',
  }
