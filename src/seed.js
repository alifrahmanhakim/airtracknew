...
const accidentIncidentRecords = [
    { tanggal: '2022-02-24', kategori: 'Serious Incident (SI)', operator: 'PT. Ekspres Transportasi Antarbenua', aoc: 'AOC 135', registrasiPesawat: 'PK-RJH', tipePesawat: 'Eurocopter EC135P2', lokasi: 'Seletar Airport', taxonomy: 'Runway Incursion' },
    { tanggal: '2022-02-26', kategori: 'Serious Incident (SI)', operator: 'PT Smart Cakrawala Aviation', aoc: 'AOC 135', registrasiPesawat: 'PK-SNB', tipePesawat: 'Pilatus PC-6 Porter', lokasi: 'Baya Biru Airstrip, Nabire', taxonomy: 'Runway Excursion (RE)' },
    { tanggal: '2022-02-28', kategori: 'Accident (A)', operator: 'PT. Spirit Avia Sentosa', aoc: 'AOC 135', registrasiPesawat: 'PK-FSW', tipePesawat: 'Cessna C208B - Grand Caravan', lokasi: 'Bilogai Sugapa, Papua', taxonomy: 'Runway Excursion (RE)' },
    { tanggal: '2022-05-24', kategori: 'Serious Incident (SI)', operator: 'PT Asi Pudjiastuti Aviation (Susi Air)', aoc: 'AOC 135', registrasiPesawat: 'PK-BVE', tipePesawat: 'Cessna C208B - Grand Caravan', lokasi: 'Bandara Yuvai Semaring Krayan, Kalimantan Utara', taxonomy: 'Ground Collision (GCOL)' },
    { tanggal: '2022-05-31', kategori: 'Serious Incident (SI)', operator: 'PT Wings Abadi Airlines', aoc: 'AOC 121', registrasiPesawat: 'PK-WGF', tipePesawat: 'ATR 72', lokasi: 'I Gusti Ngurah Rai Airport, Bali', taxonomy: 'Navigation Errors (NAV)' },
    { tanggal: '2022-06-04', kategori: 'Serious Incident (SI)', operator: 'PT Batik Air Indonesia', aoc: 'AOC 121', registrasiPesawat: 'PK-LUS', tipePesawat: 'Airbus A320', lokasi: 'Enroute from Ternate to CGK', taxonomy: 'Turbulence Encounter (TURB)' },
    { tanggal: '2022-06-08', kategori: 'Accident (A)', operator: 'PT Derazona Airlines', aoc: 'AOC 135', registrasiPesawat: 'PK-DAR', tipePesawat: 'Bell 412', lokasi: 'Enroute from Jila to Timika', taxonomy: 'Controlled Flight into or Toward Terrain (CFIT)' },
    { tanggal: '2022-06-23', kategori: 'Accident (A)', operator: 'PT Asi Pudjiastuti Aviation (Susi Air)', aoc: 'AOC 135', registrasiPesawat: 'PK-BVM', tipePesawat: 'Pilatus PC-6 Porter', lokasi: 'Duma District, Papua', taxonomy: 'Controlled Flight into or Toward Terrain (CFIT)' },
    { tanggal: '2022-06-28', kategori: 'Accident (A)', operator: 'PT AMA', aoc: 'AOC 135', registrasiPesawat: 'PK-RCQ', tipePesawat: 'Pilatus PC-6 Porter', lokasi: 'Senggi Area, Papua', taxonomy: 'Fuel Related (FUEL)' },
    { tanggal: '2022-07-12', kategori: 'Accident (A)', operator: 'Whitesky Aviation', aoc: 'AOC 135', registrasiPesawat: 'PK-WSU', tipePesawat: 'Bell 505', lokasi: 'Fly Bali Heliport, Ungasan Bali', taxonomy: 'Ground Handling (RAMP)' },
    { tanggal: '2022-07-21', kategori: 'Serious Incident (SI)', operator: 'PT Citilink Indonesia', aoc: 'AOC 121', registrasiPesawat: 'PK-GLW', tipePesawat: 'Airbus A320', lokasi: 'Juanda International Airport, Surabaya', taxonomy: 'Medical (MED)' },
    { tanggal: '2022-08-03', kategori: 'Serious Incident (SI)', operator: 'PT Wings Abadi Airlines', aoc: 'AOC 121', registrasiPesawat: 'PK-WGL', tipePesawat: 'ATR 72', lokasi: 'I Gusti Ngurah Rai Airport, Bali', taxonomy: 'System/Component Failure or Malfunction (Powerplant) (SCF-PP)' },
    { tanggal: '2022-08-14', kategori: 'Serious Incident (SI)', operator: 'PT Asia Cargo Airlines', aoc: 'AOC 121', registrasiPesawat: 'PK-YGV', tipePesawat: 'Boeing 737-300F', lokasi: 'Syamsudin Noor International Airport, Banjarmasin', taxonomy: 'Abnormal Runway Contact (ARC)' },
    { tanggal: '2022-08-30', kategori: 'Accident (A)', operator: 'PT Smart Cakrawala Aviation', aoc: 'AOC 135', registrasiPesawat: 'PK-SNW', tipePesawat: 'Cessna C208B - Grand Caravan', lokasi: 'Sinak Airport, Puncak, Papua', taxonomy: 'Runway Excursion (RE)' },
    { tanggal: '2022-09-05', kategori: 'Serious Incident (SI)', operator: 'Akademi Penerbang Indonesia Banyuwangi', aoc: 'PSC 141', registrasiPesawat: 'PK-BYC', tipePesawat: 'Cessna 172', lokasi: 'Pelengkung Beach', taxonomy: 'Low Altitude Operation (LALT)' },
    { tanggal: '2022-09-26', kategori: 'Serious Incident (SI)', operator: 'PT Pelita Air Service', aoc: 'AOC 121', registrasiPesawat: 'PK-PAH', tipePesawat: 'ATR 72', lokasi: 'Bandara Internasional Sultan Aji Muhammad Sulaiman Sepinggan, Balikpapan', taxonomy: 'Runway Excursion (RE)' },
    { tanggal: '2022-10-25', kategori: 'Serious Incident (SI)', operator: 'PT Reven Global Airtranspor', aoc: 'AOC 135', registrasiPesawat: 'PK-RVA', tipePesawat: 'Cessna C208B - Grand Caravan', lokasi: 'UPBU Ilaga, Papua', taxonomy: 'Runway Excursion (RE)' },
    { tanggal: '2022-12-01', kategori: 'Serious Incident (SI)', operator: 'PT Volta Pasifik Aviasi', aoc: 'AOC 135', registrasiPesawat: 'PK-VPJ', tipePesawat: 'Robinson R66', lokasi: 'Fly Bali Heliport, Ungasan Bali', taxonomy: 'Lost of Control-Inflight (LOC-I)' },
    { tanggal: '2022-12-05', kategori: 'Accident (A)', operator: 'PT Carpediem Aviasi Mandiri', aoc: 'AOC 135', registrasiPesawat: 'PK-CDO', tipePesawat: 'Bell 206B3', lokasi: 'Area Mining 01 Helipad', taxonomy: 'Ground Handling (RAMP)' },
    { tanggal: '2022-12-17', kategori: 'Serious Incident (SI)', operator: 'PT Sinar Mas Super Air', aoc: 'OC 137', registrasiPesawat: 'PK-PND', tipePesawat: 'Thrush S2R-T34', lokasi: 'Kajui Airstrip', taxonomy: 'Runway Excursion (RE)' },
    { tanggal: '2022-12-23', kategori: 'Accident (A)', operator: 'PT Rimbun Abadi Aviasi', aoc: 'AOC 135', registrasiPesawat: 'PK-OTY', tipePesawat: 'DHC6-300 Twin Otter', lokasi: 'Bandara Moanamani', taxonomy: 'Runway Excursion (RE)' },
    { tanggal: '2025-01-27', kategori: 'Serious Incident (SI)', operator: 'Garuda Indonesia', aoc: 'AOC 119_121', registrasiPesawat: 'PK-GMC', tipePesawat: 'Boeing 737-800', lokasi: 'Enroute from Aceh to Jakarta', taxonomy: 'Turbulence Encounter (TURB)', keteranganKejadian: 'Pesawat mengalami Turbulensi pada saat cruising level, pesawat melanjutkan penerbangan ke Jakarta dan mendarat dengan selamat.', korbanJiwa: 'Tidak ada' },
    { tanggal: '2025-02-04', kategori: 'Accident (A)', operator: 'Akademi Penerbangan Indonesia Banyuwangi', aoc: 'PSC 141', registrasiPesawat: 'PK-BYK', tipePesawat: 'Cessna C172', lokasi: 'Coastline South of Banyuwangi Airport', taxonomy: 'System/Component Failure or Malfunction (Powerplant) (SCF-PP)', keteranganKejadian: 'Pesawat mengalami engine loss saat meninggalkan area latihan Teluk Panggang dan melakukan pendaratan darurat di perairan dekat pantai Gumuk Kantong.', korbanJiwa: 'Tidak ada' },
    { tanggal: '2025-02-06', kategori: 'Accident (A)', operator: 'Zaveryna Utama', aoc: 'AOC 119_135', registrasiPesawat: 'PK-ZUV', tipePesawat: 'Bell 206 L4', lokasi: 'Pahang, Malaysia', taxonomy: 'Loss of Control Inflight (LOC-I)', keteranganKejadian: 'Helikopter tengah melaksanakan pekerjaan external load kehilangan kendali saat hover untuk landing mengalami terguling, dan terbakar. Satu engineer meninggal akibat tertabrak bilah rotor, sementara pilot selamat dengan luka ringan.', korbanJiwa: 'Ada (1 enginner)' },
    { tanggal: '2025-02-14', kategori: 'Serious Incident (SI)', operator: 'Transnusa Air service', aoc: 'AOC 119_121', registrasiPesawat: 'PK-TLG', tipePesawat: 'A321-211', lokasi: 'Sultan Abdul Aziz Shah Subang Airport, Malaysia', taxonomy: 'Abnormal Runway Contact (ARC)', keteranganKejadian: 'Pada saat melakukan pendaratan, pesawat mengalami severe hard landing. PIC tidak melaporkan kondisi tersebut, sehingga terlambat mendeteksi kerusakan pesawat.', korbanJiwa: 'Tidak ada' },
    { tanggal: '2025-03-08', kategori: 'Serious Incident (SI)', operator: 'Airfast Indonesia', aoc: 'AOC 119_135', registrasiPesawat: 'PK-OAM', tipePesawat: 'DHC6-400 Amphibian', lokasi: 'I Gusti Ngurang Rai International Airport, Denpasar', taxonomy: 'Abnormal Runway Contact (ARC)', keteranganKejadian: 'Pada saat mendarat di runway pesawat mendarat dengan roda pendaratan tidak diturunkan. Seluruh penumpang dan awak selamat tanpa korban jiwa.', korbanJiwa: 'Tidak ada' },
    { tanggal: '2025-04-22', kategori: 'Accident (A)', operator: 'National Utility Helicopter', aoc: 'AOC 119_135', registrasiPesawat: 'PK-URT', tipePesawat: 'Bell 505', lokasi: 'Wiladatika Airstrip, Cibubur', taxonomy: 'Abnormal Runway Contact (ARC)', keteranganKejadian: 'Helikopter mengalami kecelakaan saat latihan circuit ke-7 dengan simulasi autorotation di Wiladatika, Cibubur. Helikopter menghantam landasan, namun instruktur dan siswa penerbang selamat tanpa luka.', korbanJiwa: 'Tidak ada' },
    { tanggal: '2025-04-26', kategori: 'Accident (A)', operator: 'Agronusa Dirgantara', aoc: '119_OC 91', registrasiPesawat: 'PK-ITA', tipePesawat: 'AT502-B', lokasi: 'Indo Lampung Perkasa Airstrip, Lampung', taxonomy: 'Runway Excursion (RE)', keteranganKejadian: 'Pesawat keluar landasan saat take off di runway 27 Airstrip ILP dan menabrak tanggul sisi kiri runway. pesawat mengalami kerusakan parah. Pilot selamat tanpa cedera.', korbanJiwa: 'Tidak ada' },
    { tanggal: '2025-05-19', kategori: 'Serious Incident (SI)', operator: 'Jet Star Asia', aoc: 'FAOC 129', registrasiPesawat: '9V-JSK', tipePesawat: 'Airbus A320', lokasi: 'Juanda International Airport, Surabaya', taxonomy: 'ATM/CNS (ATM)', keteranganKejadian: 'Pada saat pesawat taxy ke arah taxiway 02, terdapat helikopter militer yang bergerak dan mendarat sekitar 100 meter di depan taxiway 02. Tidak ada informasi dari ATC terkait kegiatan helikopter militer tersebut dan juga tidak ada instruksi ATC kepada pesawat jetstar untuk berhenti sebelum taxiway SP2', korbanJiwa: 'Tidak ada' },
    { tanggal: '2025-06-10', kategori: 'Serious Incident (SI)', operator: 'Smart Cakrawala Aviation', aoc: 'AOC 119_135', registrasiPesawat: 'PK-SNV', tipePesawat: 'Cessna C208B - Grand Caravan', lokasi: 'Douw Aturure Airport Nabire', taxonomy: 'Runway Excursion (RE)', keteranganKejadian: 'Setelah mendarat di Bandara Douw Aturure, Nabire, pesawat berbelok kekiri dan tidak dapat dikontrol. Karena ban utama kiri kempes akibat tertancap screw. Tidak ada kerusakan lain pada pesawat.', korbanJiwa: 'Tidak ada' },
    { tanggal: '2025-06-23', kategori: 'Serious Incident (SI)', operator: 'Wings Abadi Airlines', aoc: 'AOC 119_121', registrasiPesawat: 'PK-WJZ', tipePesawat: 'ATR 72-600', lokasi: 'Sultan Aji Muhammad Sulaiman Sepinggan, Balikpapan', taxonomy: 'Fuel Related (FUEL)', keteranganKejadian: 'Saat Final Approach pesawat mengalami engine no.2 flame-out, pilot mendaratkan pesawat dengan selamat.', korbanJiwa: 'Tidak ada' },
    { tanggal: '2025-06-28', kategori: 'Serious Incident (SI)', operator: 'Pelita Air Services', aoc: 'AOC 119_121', registrasiPesawat: 'PK-PWJ', tipePesawat: 'Airbus A320', lokasi: 'Sultan Syarif Kasim II Airport, Pekanbaru', taxonomy: 'Abnormal Runway Contact (ARC)', keteranganKejadian: 'Pesawat mengalami suspected hard landing saat final approach di RW18 dengan Vertical G tercatat 2,55 G. PF sempat meminta go-around, namun PM memutuskan melanjutkan pendaratan.', korbanJiwa: 'Tidak ada' },
    { tanggal: '2025-07-06', kategori: 'Accident (A)', operator: 'Garuda Indonesia', aoc: 'AOC 119_121', registrasiPesawat: 'PK-GFR', tipePesawat: 'Boeing 737-800', lokasi: 'Enroute WAMM - WIII', taxonomy: 'Turbulence Encounter (TURB)', keteranganKejadian: 'Saat en route penerbangan Manado ke Jakarta, pesawat mengalami moderate turbulensi, mengakibatkan satu pramugari terluka karena terkena air panas.', korbanJiwa: 'Tidak ada' },
    { tanggal: '2025-07-10', kategori: 'Serious Incident (SI)', operator: 'Alda Air', aoc: 'AOC 119_135', registrasiPesawat: 'PK-DLA', tipePesawat: 'Cessna C208B - Grand Caravan', lokasi: 'Mulia Airport, Papua', taxonomy: 'Runway Excursion (RE)', keteranganKejadian: 'Pada saat pesawat touchdown, ban kanan utama mengalami flat tire. PIC berhasil mengarahkan pesawat ke sisi kanan runway dan mendarat dengan aman.', korbanJiwa: 'Tidak ada' },
    { tanggal: '2025-08-25', kategori: 'Accident (A)', operator: 'PT Aviasi Puncak Papua', aoc: 'AOC 119_135', registrasiPesawat: 'PK-PPI', tipePesawat: 'Cessna Grand Caravan 208B', lokasi: 'Bandara Udara Ilaga, Papua', taxonomy: 'Runway Excursion (RE)', keteranganKejadian: 'Setelah mendarat pesawat tidak dapat dapat berhenti dan menghantam pos penjagaan di ujung landasan. Bagian depan engine terbakar yang diikuti dengan terbakarnya badan pesawat.', korbanJiwa: 'Tidak ada' },
    { tanggal: '2025-08-25', kategori: 'Serious Incident (SI)', operator: 'PT Smart Aviation', aoc: 'AOC 119_135', registrasiPesawat: 'PK-SNU', tipePesawat: 'PAC750 XL', lokasi: 'Bandara Moses Kilangi Timika', taxonomy: 'SCF-NP (System/Component Failure - Non-Powerplant)', keteranganKejadian: 'Pesawat mengalami permasalahan mesin dan gagal mencapai Runway 12, sehingga melakukan pendaratan darurat di area final approach sebelum runway.', korbanJiwa: 'Tidak ada' },
    { tanggal: '2025-09-01', kategori: 'Accident (A)', operator: 'Eastindo Air', aoc: 'AOC 119_135', registrasiPesawat: 'PK-RGH', tipePesawat: 'BK117-D3', lokasi: 'Mentewe, Kalimantan Selatan', taxonomy: null, keteranganKejadian: 'Helikopter hilang kontak setelah lepas landas dari Bandara Gusti Sjamsir Alam, Kotabaru menuju Palangka Raya pada 3 September 2025. Helikopter kemudian ditemukan jatuh di Hutan Mandin Damar, Tanah Bumbu.', korbanJiwa: 'Ada (2 pilot serta 6 penumpang meninggal)' },
    { tanggal: '2025-09-10', kategori: 'Accident (A)', operator: 'PT intan Angkasa Air service', aoc: 'AOC 119_135', registrasiPesawat: 'PK-IWS', tipePesawat: 'AS 350 B3', lokasi: 'Timika', taxonomy: 'Turbulence Encounter (TURB)', keteranganKejadian: 'Helikopter hilang kontak dalam penerbangan dari Ilaga menuju Timika, Papua. Lokasi jatuhnya ditemukan di Distrik Jila, Kabupaten Mimika.', korbanJiwa: 'Ada (4 orang)' },
];
